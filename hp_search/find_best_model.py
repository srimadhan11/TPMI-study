...
print("overall best FID : {}"       .format(np.argmax(fid_hist)))
print("overall best ELBO : {}"      .format(np.argmax(elbo_hist)))
print("overall best Conistency : {}".format(np.argmax(consistency_hist)))
